defmodule UndiOnlineWeb.UserSettingsLive do
  ...
  def handle_event("validate_email", params, socket) do
    ...
    email_changeset = Users.change_user_email(socket.assigns.current_user, user_params)
  ...
  def handle_event("validate_password", params, socket) do
    %{"current_password" => password, "user" => user_params} = params
    password_changeset = Users.change_user_password(socket.assigns.current_user, user_params)
    ...
    case Users.update_user_password(user, password, user_params) do
      {:ok, user} ->
        socket =
          ...
          |> assign(:password_changeset, Users.change_user_password(user, user_params))
