defmodule UndiOnline.Accounts do
  @moduledoc """
  ...
  alias UndiOnline.Accounts.Membership
  alias UndiOnline.Accounts.Member
  alias UndiOnline.Accounts.Invitation
  ...
  use Phoenix.VerifiedRoutes, endpoint: UndiOnlineWeb.Endpoint, router: UndiOnlineWeb.Router
  alias UndiOnline.Mailer
  alias UndiOnline.Accounts.InvitationNotifier
