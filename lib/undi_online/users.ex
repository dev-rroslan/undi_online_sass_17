defmodule UndiOnline.Users do
  ...
  alias UndiOnline.Users.{User, UserToken, UserNotifier}
  ...
  def with_memberships(user) do
    user
    |> Repo.preload([:memberships, :accounts], skip_account_id: true)
  end

  @doc """
  Returns user with a personal_account.

  ## Examples

      iex> with_personal_account(user)
      %User{personal_account: %Account{}}

  """
  def with_personal_account(user) do
    user
    |> Repo.preload(:personal_account)
  end
